...
class MPC():
    def __init__(self, auv, mpc_params):
        ...
        self.acados_ocp_solver = AcadosOcpSolver(
            self.acados_ocp, json_file="acados_nmpc_" + self.acados_ocp.model.name + ".json"
        )
    ...
    def nonlinear_dynamics(self, x, u, full_body):
        ...
        # x_dot = self.auv.compute_nonlinear_dynamics(x, u, nu_w=nu_w, nu_w_dot=nu_w_dot, complete_model=full_body)
        return x_dot
    ...
    def create_ocp_solver_description(self):
        ...
        self.acados_ocp.solver_options.hessian_approx = "GAUSS_NEWTON"  # 'GAUSS_NEWTON', 'EXACT'
